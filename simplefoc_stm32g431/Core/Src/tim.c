...
void MX_TIM1_Init(void)
{
  ...
  sBreakDeadTimeConfig.DeadTime = MOS_DEADTIME;
...
void MX_TIM2_Init(void)
{
  ...
  htim2.Instance = TIM2;
  htim2.Init.Prescaler = RX_PRESCALER;
...
void MX_TIM4_Init(void)
{
  ...
  htim4.Instance = TIM4;
  htim4.Init.Prescaler = TX_PRESCALER;
...
void MX_TIM6_Init(void)
{
  ...
  htim6.Instance = TIM6;
  htim6.Init.Prescaler = ISR_PRESCALER;
...
void MX_TIM15_Init(void)
{
  ...
  htim15.Init.Prescaler = TX_PRESCALER;
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    PB11     ------> TIM2_CH4
    */
    GPIO_InitStruct.Pin = R_L_Pin|R_R_Pin;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM15_MspPostInit 0 */
    ...
    PA3     ------> TIM15_CH2
    */
    GPIO_InitStruct.Pin = L_L_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF9_TIM15;
    HAL_GPIO_Init(L_L_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_PWM_MspDeInit(TIM_HandleTypeDef* tim_pwmHandle)
{
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_6|GPIO_PIN_8
                          |GPIO_PIN_9);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB11     ------> TIM2_CH4
    */
    HAL_GPIO_DeInit(GPIOB, R_L_Pin|R_R_Pin);
