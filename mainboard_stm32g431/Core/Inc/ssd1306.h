...
void ssd1306_WriteFloat(double dat, uint8_t num, uint8_t pointnum, FontDef Font);
...
/* you can create a function for the end of the update (attention!: interrupt function) */
#define ssd1306_ContUpdateEnable()
#define ssd1306_ContUpdateDisable()
#define ssd1306_SetRasterInt(r)
...
/* enable raster interrupt(s) of PAGEx (0:NONE, 1:PAGE0, 2:PAGE1, 4:PAGE2 ... 128:PAGE7, 255:All_PAGES) */
__weak void ssd1306_RasterIntCallback(uint8_t r);
/* 0:At the beginning of PAGE0, 1:PAGE1, 2:PAGE2 ... 7:PAGE7 (attention!: interrupt function) */
#endif
#endif
